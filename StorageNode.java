...
public class StorageNode {
	...
	public static void main(String[] args) throws Exception {
		...
		// cleanup is reinforced in monitoring thread
		...
		// prevent children.size() == 0
		curClient.create().withMode(CreateMode.EPHEMERAL_SEQUENTIAL).forPath(args[3] + "/Worker", (args[0] + ":" + args[1]).getBytes());
		...
		MonitorThread monitor = new MonitorThread(args[3], curClient);
		monitor.start();
	}
}
